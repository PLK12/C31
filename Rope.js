...
// when you want to perform 2 task at the same time
  //stack(xx, yy, columns, rows, columnGap (distance between the two), rowGap, callback)
  ...
  World.add(myEngine.world, this.body);
    ...
    //composite stores similar objects with same properties and same behaviors, array without variability, consists of multiple bodies;
